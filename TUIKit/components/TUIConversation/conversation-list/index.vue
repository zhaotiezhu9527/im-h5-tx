<template>
  <ul class="tui-conversation-list"
    ref="listRef"
  ...
  >
    ...
    >
      <div
        @click.stop="handleSwitchConversation(conversation.conversationID)"
...
const handleSwitchConversation = (conversationID: string) => {
  if (isLongpressing.value || toggleID.value === conversationID) {
    return;
  }
...
defineExpose({ setListRectInfo, closeChildren });
</script>
