...
import { computed, reactive, defineEmits, ref, watchEffect, defineProps } from "../../../adapter-vue";
import documentLink from "../../../utils/documentLink";
import Icon from "../../common/Icon.vue"
import backIcon from "../../../assets/icon/back.svg";
import closeIcon from "../../../assets/icon/close.png";
import rightIcon from "../../../assets/icon/right.png";
import GroupIntroduction from "./groupConfig.vue";
import { groupConfig, findGroupConfig } from "./groupConfig";
...
const groupInfo = reactive<any>({
  profile: {
    groupID: '',
    name: '',
    type: groupConfig[0].type,
    avatar: groupConfig[0].icon,
    introduction: '',
    notification: '',
    // joinOption: '',
    memberList: [],
...
const groupTypeDetail = computed(() => {
  return findGroupConfig(groupInfo.profile.type);
});
...
const selected = (type: any) => {
  if (groupInfo.profile.type !== type) {
    ...
    groupInfo.profile.avatar = findGroupConfig(type).icon;
    if (groupInfo.isEdit) {
